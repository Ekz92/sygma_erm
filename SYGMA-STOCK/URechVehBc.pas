...
procedure TfrmRechVehBc.FormShow(Sender: TObject);
var
  Psql : string;
  vehs : TVehiculeArray;
  i:integer;
...
//  end else
//  begin
//    MessageDlg('Vous devez clôturer la commande en cours sur ce véhicule avant de la charger à nouveau',mtError,[mbRetry],0);
  end;
    close;
end;
