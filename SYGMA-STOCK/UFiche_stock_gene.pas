...
procedure TfrmFiche_stock_gene.Button1Click(Sender: TObject);
var
  sql : string;
begin
...
procedure TfrmFiche_stock_gene.FormCreate(Sender: TObject);
begin
with StringGrid1 do
  begin
    Cells[0,0]:='Code art';
...
procedure TfrmFiche_stock_gene.StringGrid1DrawCell(Sender: TObject; ACol,
