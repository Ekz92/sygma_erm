object frmFiche_stock_gene: TfrmFiche_stock_gene
  Left = 0
  Top = 0
  Caption = 'Fiche de stock g'#233'n'#233'rale'
  ClientHeight = 325
  ClientWidth = 563
  Color = clBtnFace
  ...
  object QFiche_stock: TSQLQuery
    ...
    Params = <>
    SQL.Strings = (
      'select * from tb_article A, tb_stock_gene S')
  ...
  object frxE_Fiche_stock: TfrxReport
    ...
    ReportOptions.LastChange = 44672.351831990700000000
