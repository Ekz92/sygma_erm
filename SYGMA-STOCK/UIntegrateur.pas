...
//frmAdd_magasin.ShowModal;
  ...
  st_SideMenu.Cells[0,1] := 'Créer un nouveau magasin';
...
with st_SideMenu do
  begin
    Cells[0,1]:='Entrée en stock';
    Cells[0,2]:='Entrée divers';
...
begin
  ...
  with st_SideMenu do
    begin
      Cells[0,1]:='Entrée en stock';
      Cells[0,2]:='Liste des entrées en stock';
      Cells[0,3]:='Fiche d''entrée' ;
      Cells[0,4]:='Liste de fiche d''entrée' ;
    end;
...
begin
//Si cest le bouton magasin et le sous menu création de magasin
...
//Si cest le bouton Etat et le sous menu etat des antrées annulee ...
