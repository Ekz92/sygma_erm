...
procedure Tfrmtype_vehicule.FormCreate(Sender: TObject);
begin
with StringGrid1 do
  begin
    Cells[0,0] := 'Num(Auto)';
...
procedure Tfrmtype_vehicule.SpeedButton2Click(Sender: TObject);
begin
eddesign.Clear;
SB_Add.Enabled:=true;
SB_Modifier.Enabled:=false;
...
procedure Tfrmtype_vehicule.StringGrid1DrawCell(Sender: TObject; ACol,
