...
type
  TfrmListeFacture = class(TForm)
    ...
    QConsultationid_fact: TIntegerField;
    QConsultationdate_fact: TSQLTimeStampField;
    QConsultationnum_fact: TStringField;
    QConsultationcode_mag: TStringField;
    QConsultationcode_clt: TStringField;
    QConsultationnom_clt: TStringField;
    QConsultationpdv_cdp: TStringField;
    QConsultationqte_total: TIntegerField;
    QConsultationmnt_t: TFloatField;
    QConsultationmnt_p: TFloatField;
    QConsultationmnt_r: TIntegerField;
    QConsultationstatut: TStringField;
    QConsultationtype_fact: TStringField;
    QConsultationnum_comc: TStringField;
    QConsultationvehicule: TStringField;
    QConsultationstatut_canc: TIntegerField;
    QConsultationusager: TStringField;
    QConsultationid_fact_1: TIntegerField;
    QConsultationdate_fact_1: TSQLTimeStampField;
    QConsultationnum_fact_1: TStringField;
    QConsultationcode_mag_1: TStringField;
    QConsultationdesignation_mag: TStringField;
    QConsultationcode_tclt: TStringField;
    QConsultationdesignation_tclt: TStringField;
    QConsultationcode_clt_1: TStringField;
    QConsultationnom_clt_1: TStringField;
    QConsultationcode_art: TStringField;
    QConsultationdesignation_art: TStringField;
    QConsultationPrixU: TFloatField;
    QConsultationPrixT: TFloatField;
    QConsultationqte_art: TFloatField;
