...
procedure TfrmIntegrateur.Cumuledeventeparclient1Click(Sender: TObject);
begin
frmCumuleFacture.ShowModal;
end;

procedure TfrmIntegrateur.Diagrammedefacture1Click(Sender: TObject);
begin
frmDiagramDayFact.ShowModal;
end;
